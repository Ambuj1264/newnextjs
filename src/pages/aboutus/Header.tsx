...
const Header = () => {
    return (
        <div>
            <header className="relative bg-cover bg-center min-h-[450px] text-white bg-[url('/assets/images/headerbg.png')] ">
                <div className="container mx-auto flex items-center justify-center md:gap-10 md:flex-row flex-col">
                    <div className="flex-grow w-full my-5">
                        <Image src="/assets/images/headerImg.png" width={776} height={388} alt='headerimg' />
                    </div>
